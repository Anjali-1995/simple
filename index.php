...
.align{
  ...
  <H1 class="align" > REGISTER USER </H1>
  
   <div class="container" >
   <form action="savedata1.php" method="POST">
    ...
    <div class="mb-3">
      ...
      <input name="email" type="text" class="form-control" id="formGroupExampleInput2" placeholder="Another input placeholder" >
    </div>
    <div class="mb-3">
